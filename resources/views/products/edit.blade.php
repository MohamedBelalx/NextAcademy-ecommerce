    ...
    <div class="card-body">
        ...
        <form action="{{route('products.update',['id' => $products->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                ...
                <input type="text" class="form-control" name="decription" value="{{$products->decription}}">
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3">
                ...
                <img src="{{asset($products->img)}}" alt="" width="150">
            </div>
            <div class="mt-3">
                ...
                <select name="trade_mark_id" class="form-select" aria-label="Default select example">
                    <option selected value="{{$products->trade_mark_id}}">{{$products->tradeMarks->title}}</option>
